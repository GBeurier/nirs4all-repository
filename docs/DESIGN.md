...
**nirs4all.org visual system** (warm-paper canvas, IBM Plex Sans / Inter / JetBrains
Mono, the eco-card grid, the animated spectral strip) with the **repository brick
accent `#AC564A`** (`n4r` lettermark) instead of the umbrella teal. It renders:

- a landing/hero with the repository brand mark and catalogue summary;
