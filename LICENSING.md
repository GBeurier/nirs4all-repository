# Licensing — nirs4all-repository

`nirs4all-repository` is part of the **nirs4all ecosystem** and is offered under a
...
for example, embedding `nirs4all-repository` in a **proprietary, closed-source product or SaaS**
...
`nirs4all-repository` relies on third-party open-source components. Their licenses are summarized
